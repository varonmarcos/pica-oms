 ...
 */
@Stateless
public class LdapBean implements LdapSvc {
	...
	cnDTO = new LdapConnectionDTO();          
        ...
        {        
            ...
            InputStream in = LdapBean.class.getClassLoader().getResourceAsStream("com/kallSonys/common/dal/configuration/resources/ldapConfiguration.properties");
            if(in == null)
            {
